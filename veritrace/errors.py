...
class Errors:
    ...
    @staticmethod
    def injection_detected(findings: list) -> VtError:
        return VtError(
    ...
    @staticmethod
    def input_too_large(size: int, limit: int) -> VtError:
        return VtError(
    ...
    @staticmethod
    def tool_blocked(tool: str, reason: str) -> VtError:
        return VtError(
            code="TOOL_BLOCKED",
    ...
    @staticmethod
    def tool_schema_violation(tool: str, reason: str) -> VtError:
        return VtError(
    ...
    @staticmethod
    def tool_injection(tool: str, findings: list) -> VtError:
        return VtError(
    ...
    @staticmethod
    def output_exfiltration(tool: str, findings: list) -> VtError:
        return VtError(
    ...
    @staticmethod
    def safety_blocked(rule_ids: list[str]) -> VtError:
        return VtError(
            code="SAFETY_BLOCKED",
    ...
    @staticmethod
    def hitl_idle(action: str) -> VtError:
        return VtError(
            code="HITL_IDLE",
    ...
    @staticmethod
    def hitl_denied(action: str) -> VtError:
        return VtError(
            code="HITL_DENIED",
    ...
    @staticmethod
    def circuit_open(component: str) -> VtError:
        return VtError(
            code="CIRCUIT_OPEN",
    ...
    @staticmethod
    def provider_error(provider: str, exc: str) -> VtError:
        return VtError(
            code="PROVIDER_ERROR",
    ...
    @staticmethod
    def rate_limited(retry_after: float) -> VtError:
        return VtError(
            code="RATE_LIMITED",
    ...
    @staticmethod
    def backend_unavailable(backend: str, exc: str) -> VtError:
        return VtError(
    ...
    @staticmethod
    def isolation_violation(scope: str) -> VtError:
        return VtError(
    ...
    @staticmethod
    def llm_judge_blocked(tool: str, reason: str) -> VtError:
        return VtError(
