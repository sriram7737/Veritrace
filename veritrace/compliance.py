...
This complements ComplianceLayer (PII scrubbing in veritrace.layers): that layer
...
class ComplianceReporter:
    ...
    def build(self, *, tenant_id: Optional[str] = None,
        ...
        return {
            "report_type": "veritrace_compliance",
            "framework": framework,
    ...
    def _controls(self, framework: str) -> list[dict]:
        """Map implemented Veritrace controls to a framework's expectations."""
        base = [
