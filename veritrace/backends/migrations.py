"""
veritrace.backends.migrations
=============================
Tiny, dependency-free schema migration runner for the trace/audit stores.

Why not Alembic? Alembic is excellent but pulls in SQLAlchemy. Veritrace's
...
Usage
-----
    from veritrace.backends.migrations import MigrationRunner, Migration

    runner = MigrationRunner(sqlite_path="veritrace.db")        # or dsn=...
